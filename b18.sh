#!/bin/bash
#
# Compile script for FuAnDo ginkgo kernel
# Copyright (C) 2020-2021 Adithya R.
# Copyright (C) 2021-2024 @LeCmnGend.
#
# Download needed files
KERNEL_DIR=`pwd`
TC_BRANCH="clang-r522817"
TC_DIR="$HOME/tc/clang/$TC_BRANCH"
TC_URL="https://gitlab.com/kei-space/clang/r522817"
TC_GIT_BRANCH=master
...
ZIPNAME="FuAnDo-Violet-A14-$(date '+%Y%m%d-%H%M').zip"
...
export THINLTO_CACHE_DIR="/mnt/f/.ccache/ltocache/"
...
if [[ $1 == "-r" || $1 == "--regen" ]]; then
		...
		make $PROC O=out ARCH=arm64 \
			...
			CROSS_COMPILE_ARM32="arm-linux-gnueabi-" \
			LLVM=1 \
			LLVM_IAS=1 Image.gz-dtb dtbo.img
fi
